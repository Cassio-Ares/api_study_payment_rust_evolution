...
A main.rs é a porteira do seu servidor ela carrega configurações, conecta e abre o banco e abre a porta para receber requisições.
...
````
A macro `#[actix_web::main]` transforma uma main em assíncrona 
inicializa o runtime assíncrono do Tokio

- Estrutura inicial do projeto

OBS: mais informações sobre ````SQLx```` veja mais em [SQLx.md](./SQLx.md)
